...
public class C_service {
	...
	public ModelAndView cAdd(C_dto content) throws IllegalStateException, IOException {
		System.out.println("[2]service : content -> " + content);
		...
		if (CFile.isEmpty()) {
			content.setCPoster("NULL");
		} else {
			
			String savePath = "C:/Users/djand/Documents/workspace-spring-tool-suite-4-4.11.1.RELEASE/HomeTheater/src/main/webapp/resources/CPoster/"
					+ CPoster;
