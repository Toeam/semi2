...
<body>
	...
	<form name="CAddForm" action="C_add" method="POST"
		enctype="multipart/form-data"
		style="text-align: center; display: flex; justify-content: center; align-items: center; margin-top: 60px; margin-bottom: 120px;">
		<table>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" name="CName"
					id="CNAME" placeholder="Content Title"></td>
			</tr>
			<tr>
				<th>Summery :</th>
				<td><textarea rows="10" class="form-control" name="CSummery"
						placeholder="Write,this movie's summery"></textarea></td>
			</tr>
			<tr>
				<th>Come Out:</th>
			...
			<tr>
				<td colspan="3"><input style="font-weight: 400;"
					class="btn btn-outline-success" type="button" value="Add"
					...
					type="reset" onclick="location.href='index'" value="Home"></td>
			</tr>
		</table>
	</form>
